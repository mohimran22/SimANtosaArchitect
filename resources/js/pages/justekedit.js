window.initJustekEditForm = function () {
    ...
    const body = document.getElementById('justekEditItemsBody');
    ...
    function openEditJustekItem(index) {
        ...
        const item = justekEditItems[index];

        if (!item) {
            return;
        }
        justekEditCurrentItemIndex = index;
        renderFloorOptions();
        const floor =
            document.getElementById(
                'edit_justek_item_floor'
        ...
        document.getElementById('edit_justek_item_job_name').value = item.job_name || '';
        document.getElementById('edit_justek_item_description').value = item.description || '';
        document.getElementById('edit_justek_item_volume').value = formatDecimal(item.volume);
        document.getElementById('edit_justek_item_satuan').value = item.satuan || '';
        document.getElementById('edit_justek_item_price').value = item.base_price || 0;
        document.getElementById('edit_justek_item_price_display').value = formatRupiah(item.base_price);
        if (!justekEditModal) {
    ...
    function saveJustekEditItem() {
        ...
        const jobName = document.getElementById('edit_justek_item_job_name')?.value.trim();
        const description = document.getElementById('edit_justek_item_description')?.value.trim() || '';
        const volume = parseDecimal(document.getElementById('edit_justek_item_volume')?.value);
        const satuan = document.getElementById('edit_justek_item_satuan')?.value.trim();
        const basePrice = parseRupiah(document.getElementById('edit_justek_item_price')?.value);
    ...
    const sortButton = document.getElementById('justekEditSortButton');
    ...
    if (sortButton) {
        ...
        sortButton.addEventListener(
            ...
            function () {
                ...
                justekEditSortMode = !justekEditSortMode;
