...
{{-- <table class="no-border" width="100%" style="margin-top:40px;">
<tr>
    <td width="60%"></td>

    <td width="40%" class="text-center">
        Jember, {{ $invoice_date }}<br><br>

        <strong>Antosa Architect</strong><br><br>

        <img src="{{ public_path('images/ttd-dwiantosa.png') }}"
             style="height:90px; display:block; margin:0 auto;"><br>

        <u>Ir. Ar. Dwiantosa Ahmad F., IAI., IPP</u><br>
        Direktur Utama
    </td>
</tr>
</table> --}}
