@if ($technicalJustification->count())
    <x-collapse-card title="Laporan Justifikasi Teknis" target="detail-justek-body">
            ...
            <table class="table table-bordered align-middle">
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <th class="fw-bold">
                            Rp {{ number_format($technicalJustification->grand_total,3,',','.') }}
                        </th>
