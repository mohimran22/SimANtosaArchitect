                                        ...
                                        <div class="p-3 bg-light rounded">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select class="form-select select2 job-tambahan"
                                                        ...
                                                        @foreach($jobCategories as $job)
                                                            <option value="{{ $job->id }}">
                                                                    {{-- data-satuan="{{ $job->satuan }}"
                                                                    data-price="{{ $job->grand_total }}"> --}}
                                                                {{ $job->nama_pekerjaan }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                {{-- <div class="col-md-2">
                                                    <label>Satuan</label>
                                                    <input type="text"
                                                        class="form-control unit-tambahan"
                                                        readonly>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <label>Volume</label>
                                                    <input type="number"
                                                        class="form-control vol-tambahan">
                                                </div>

                                                <div class="col-md-2">
                                                    <label>Harga Satuan</label>
                                                    <input type="text"
                                                        class="form-control harga-satuan-tambahan"
                                                        readonly>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="text"
                                                        class="form-control jumlah-harga-tambahan"
                                                        readonly>
                                                </div> --}}
                                            </div>
                                        </div>
...
@push('js')
    ...
    <script>
        ...
        function autosaveJustek(item, week) {
            ...
            .then(r=>{
                if(!r.ok) console.warn("Justek autosave gagal");
            });
        }
