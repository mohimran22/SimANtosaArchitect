...
@push('js')
    ...
    <script>
        ...
        function autosaveCategoryPlan(categoryId, week, val){

            fetch("{{ route('build-category-plan.update') }}", {
            ...
            .then(r => {
                ...
                if(!r.ok){
                    ...
                    console.warn("Plan autosave failed");
