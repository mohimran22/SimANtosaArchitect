...
Route::middleware(['permission:lihat jurnal'])->group(function () {
...
Route::get(
    '/projects/justek/{technicalJustification}/invoice',
    [\App\Http\Controllers\JustekController::class, 'invoiceJustek']
)->name('projects.justek.invoice');
...
Route::middleware(['auth', 'permission:lihat data absensi'])->group(function () {
    ...
    Route::post('/attendance-overtimes/start', [AttendanceOvertimeController::class, 'start'])
        ->name('attendance-overtimes.start');
